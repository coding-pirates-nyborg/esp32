...
void NeoPixelControl::turn_on() {
    ...
    for (int i = 0; i < num_leds; ++i) {
        ...
        Serial.printf("Setting color of light %d r: %d g: %d b: %d \n", i, pixels[i].rgb_color.r, pixels[i].rgb_color.g, pixels[i].rgb_color.b);
        FastLED.setBrightness(pixels[i].light_strength); // Set brightness to maximum
...
void NeoPixelControl::ChangePalettePeriodically()
{
...
void NeoPixelControl::SetupTotallyRandomPalette()
{
    for( int i = 0; i < 16; i++) {
...
// to set them up.
void NeoPixelControl::SetupBlackAndWhiteStripedPalette()
{
...
void NeoPixelControl::SetupPurpleAndGreenPalette()
{
